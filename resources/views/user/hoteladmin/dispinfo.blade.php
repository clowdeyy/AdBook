            ...
            <section class="content-header">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="text-center">Update Intro Information</h3>
                        </div>
                        <div class="panel-body">
                         ...
                         @include('includes.errormessage')
                          {!! Form::open(['action' => 'HotelsController@dispinfo' , 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                      ...
                      <div class="form-group {{$errors->has('file') ? 'has-error': ''}}">
                          ...
                          <span class="help-block"> <i>In Updating Image, please take note of the image file beside Choose File button.</i></span>
                          @if ($errors->has('file'))
                          <span class="invalid-feedback" role="alert">
