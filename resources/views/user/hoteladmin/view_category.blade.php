...
<div class="hold-transition skin-green sidebar-mini">
    ...
    <br>
          ...
          <ul class="sidebar-menu">
            <li class="header"><h4>{{auth()->user()->hname}}</h4></li>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li role="presentation" class="active"><a href="{{--{{route('hoteladmin')}}--}}">Categories</a></li>
                            </ul> 

                           
                            <a href="{{route('createcategory')}}" class="btn btn-primary">Create Room Category</a>
                            ...
                            @if(count($category)>0)
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><img style="width:80px; height:70px;" src="/storage/cat_images/{{$cat->cat_image}}"></td> 
                                        <td><b>{{$cat->name}}</b></td>
                                        <td width="50%">{{$cat->description}}</td>
                                        <td>&#8369;{{$cat->price}}</td>
                                        <td>
                                        <form action="{{--{{route('admin_lock_me', ['id'=> $user->id])}}" method="get" id="formDel{{$user->id}}--}}">
                                            ...
                                            <button type="button" value="" class="btn btn-danger btn-xs delMe"><i class="glyphicon glyphicon-trash"></i></button>
                                        </form>
                                        </td> 
                                    </tr>     
                                @endforeach
